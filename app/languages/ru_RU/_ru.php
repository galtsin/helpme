...
return array(
		...
		Zend_Validate_Identical::NOT_SAME => 'Ошибка при обращении к форме',
		...
		Zend_Validate_NotEmpty::IS_EMPTY => 'Отсутствует значение, пожалуйста, заполните поле',
		...
		Zend_Validate_Db_NoRecordExists::ERROR_RECORD_FOUND => 'Запись "%value%" уже существует',
		Zend_Validate_Db_RecordExists::ERROR_NO_RECORD_FOUND => 'Записи "%value%" не существует',
		Zend_Captcha_ReCaptcha::BAD_CAPTCHA => 'Вы ввели неверный код',
		Zend_Captcha_ReCaptcha::ERR_CAPTCHA => 'Ошибка в секретной фразе',
		Zend_Captcha_ReCaptcha::MISSING_VALUE => 'Вы не указали защитный код',
);
